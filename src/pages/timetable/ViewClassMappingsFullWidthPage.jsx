...
// function ViewClassMappingsFullWidthPage() {
...
//       <Sidebar />
//       <main className="main-content" style={{ fontSize: '18px', width: '100vw', minHeight: '100vh', margin: 0, padding: 0, overflow: 'hidden' }}>
//         <Navbar />
//         <div className="timetable-form-container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100vw', maxWidth: '100vw', margin: 0, padding: 0 }}>
//           <h1 style={{ textAlign: 'center', width: '100%' }}>View Class Mappings (Full Width)</h1>
...
//             </select>
//           </div>
//           <div style={{ width: '100vw', maxWidth: '100vw', margin: 0, overflowX: 'auto', display: 'block', padding: 0 }}>
//             {selectedClass && mappings.length > 0 && (
//               <div style={{ width: '100vw', maxWidth: '100vw', display: 'block', margin: 0, padding: 0 }}>
...
// export default ViewClassMappingsFullWidthPage;
